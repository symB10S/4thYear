...
while hasFrame(video_input)
    ...
    frame_resized = im2uint8 (imresize( frame_current,frame_scale_factor ));
    
    [bboxes,scores] = detect(fasterRCNN,frame_resized);
...
%         box_y2 = box_y1 + bounding_box(label_current).BoundingBox(4);
        ...
        box_x1 = bboxes(label_current,1);
        box_y1 = bboxes(label_current,2);
        box_x2 = bboxes(label_current,3);
        box_y2 = bboxes(label_current,4);
